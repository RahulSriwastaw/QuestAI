  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center">
        <div className={`p-4 rounded-2xl mb-4 transition-all duration-300 flex items-center justify-center ${disabled ? 'bg-slate-50 text-slate-300' : 'bg-peach text-primary'}`}>
